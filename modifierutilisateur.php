...
$sql=("UPDATE utilisateur SET NomUser='$nom', PrenUser='$prenom' ,TelUser='$tel' ,typeUser='$type',logUser
	='$login',passUser='$pass',id_Serv='$id_ser',id_Fact='$id_fac' WHERE CinUser='$id' ");
...
<td width="10%"><a href="modifierutilisateur.php?CinUser=<?php echo $sql2['CinUser']; ?>">Modifier</a></td>
</tr>
<?php } ?>
</table>
<?php } ?>
